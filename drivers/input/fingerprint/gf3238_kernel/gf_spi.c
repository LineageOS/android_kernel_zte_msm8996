...
#ifdef GF_DEBUG
#define gf_dbg(fmt, args...) pr_warn("gf3238:" fmt, ##args)
#define FUNC_ENTRY()  pr_warn("gf3238:%s, entry\n", __func__)
#define FUNC_EXIT()  pr_warn("gf3238:%s, exit\n", __func__)
#else
