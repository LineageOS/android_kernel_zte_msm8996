...
#define BH1745_PPERS_0	0x00
/* Interrupt status is updated at each measurement end. */
#define BH1745_PPERS_1	0x01
/* Interrupt status is updated
  *if 4 consecutive threshold judgments are the same
  */
#define BH1745_PPERS_2	0x10
/*Interrupt status is updated
  *if 8 consecutive threshold judgments are the same*/
#define BH1745_PPERS_3	0x11

#define BH1745_RGB_DATA_MAX          65536
#define BH1745_LUX_MAX                       30000

/* POWER SUPPLY VOLTAGE RANGE */
#define BH1745_VDD_MIN_UV  3008000
#define BH1745_VDD_MAX_UV  3008000
#define BH1745_VIO_MIN_UV  1800000
#define BH1745_VIO_MAX_UV  1800000


/* the parameter for lux calculation formula for the corresponding GAGAIN */
