...
$(TARGET_PREBUILT_INT_KERNEL): $(KERNEL_OUT) $(KERNEL_HEADERS_INSTALL)
	...
	$(MAKE) -C kernel O=../$(KERNEL_OUT) KCFLAGS+="$(ZTE_FEATURE_FLAGS_TO_KERNEL)" ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(KERNEL_CFLAGS)
	$(MAKE) -C kernel O=../$(KERNEL_OUT) KCFLAGS+="$(ZTE_FEATURE_FLAGS_TO_KERNEL)" ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(KERNEL_CFLAGS) modules
